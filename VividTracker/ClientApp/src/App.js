...
import ManageTrackerItems from './components/ManageTrackerItems/ManageTrackerItems';
  ...
  render () {
    return (
      <Layout>
        ...
        <AuthorizeRoute path='/manageTenantTrackers/:tenantID' component={ManageTrackerItems} />
